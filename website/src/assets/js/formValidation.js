$("form").submit(function(event) {
  ...
  if (checkValidations(payloadArray) == true) {
    ...
    $.ajax({
      ...
      dataType: 'json',
      data: 'fullname=' + payloadArray.FULL_NAME + '&phonenumber=' + payloadArray.PHONE_NUMBER + '&email=' + payloadArray.EMAIL + '&message=' + payloadArray.MESSAGE + '&company=' + payloadArray.COMPANY,
      beforeSend: function() {
