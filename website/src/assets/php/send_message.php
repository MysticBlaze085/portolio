...
$subject = 'You have a inquiry for an Your Portfolio';
...
if (!$sentMail) {
    ...
    $output = json_encode(array('type' => 'message', 'text' => 'Hello! ' . $full_name . ' Thank you for your interest, Melissa will contact you shortly.'));
    die($output);
}
}
 ?>
